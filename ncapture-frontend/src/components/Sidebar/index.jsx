...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-99 p-5 flex h-screen w-full md:w-80 flex-col overflow-y-hidden  text-white duration-300 ease-linear lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      style={{
        backgroundImage: `linear-gradient(to left, rgba(0, 0, 0, 0.93), rgba(0, 0, 0, 0.93 )), url(${bg})`,
    ...
    >
      ...
      <div className='flex justify-center items-center'>
        <h1 className='text-4xl font-medium my-5 text-green-500'>Ncapture</h1>
      </div>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {(userRole == "administrator" || userRole == "staff" || userRole == "lecturer") && <li>
                <NavLink
                  to="/createEvent"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('chart') && 'bg-graydark dark:bg-meta-4'
                    }`}
          ...
          {userRole == "mediaAdmin" && <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to={"/assignMediaMember"}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('chart') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <RiShieldUserFill />
                  Assign Media Members
                </NavLink>
              </li>
            </ul>
          </div>}
          {userRole == "mediaMember" && <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
              Media Member
            </h3>
